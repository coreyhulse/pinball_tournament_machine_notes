...
* It is recommended to turn off Extra Balls and have them score 50K (via Self Test 16 and 17 set to â01â)
* There is both âRedâ and âBlueâ bonus on this game. If the Red Bonus earning opportunities are not nerfed, it creates a opportunity to run the multiplier up to 5x and backhand the right saucer for continuous 115k shots that are slow to collect, safe, and repetitive.
